...
ChoreographyTask::ChoreographyTask(const ChoreographyTask& from)
  ...
  ChoreographyTask* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void ChoreographyTask::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ChoreographyTask*>(&to_msg);
  auto& from = static_cast<const ChoreographyTask&>(from_msg);
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_impl_.processor_ = from._impl_.processor_;
    }
    if (cached_has_bits & 0x00000004u) {
...
ChoreographyConf::ChoreographyConf(const ChoreographyConf& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  ChoreographyConf* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
  ...
  if (from._internal_has_choreography_affinity()) {
    _this->_impl_.choreography_affinity_.Set(from._internal_choreography_affinity(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_choreography_processor_policy()) {
    _this->_impl_.choreography_processor_policy_.Set(from._internal_choreography_processor_policy(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_choreography_cpuset()) {
    _this->_impl_.choreography_cpuset_.Set(from._internal_choreography_cpuset(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_pool_affinity()) {
    _this->_impl_.pool_affinity_.Set(from._internal_pool_affinity(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_pool_processor_policy()) {
    _this->_impl_.pool_processor_policy_.Set(from._internal_pool_processor_policy(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_pool_cpuset()) {
    _this->_impl_.pool_cpuset_.Set(from._internal_pool_cpuset(), 
      _this->GetArenaForAllocation());
  }
...
void ChoreographyConf::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ChoreographyConf*>(&to_msg);
  auto& from = static_cast<const ChoreographyConf&>(from_msg);
  ...
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_set_choreography_affinity(from._internal_choreography_affinity());
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_set_choreography_processor_policy(from._internal_choreography_processor_policy());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_set_choreography_cpuset(from._internal_choreography_cpuset());
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_internal_set_pool_affinity(from._internal_pool_affinity());
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_internal_set_pool_processor_policy(from._internal_pool_processor_policy());
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_internal_set_pool_cpuset(from._internal_pool_cpuset());
    }
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.choreography_processor_num_ = from._impl_.choreography_processor_num_;
    }
    if (cached_has_bits & 0x00000080u) {
      _this->_impl_.choreography_processor_prio_ = from._impl_.choreography_processor_prio_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x00000300u) {
    if (cached_has_bits & 0x00000100u) {
      _this->_impl_.pool_processor_num_ = from._impl_.pool_processor_num_;
    }
    if (cached_has_bits & 0x00000200u) {
      _this->_impl_.pool_processor_prio_ = from._impl_.pool_processor_prio_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
