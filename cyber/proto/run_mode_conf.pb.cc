...
RunModeConf::RunModeConf(const RunModeConf& from)
  ...
  RunModeConf* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void RunModeConf::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RunModeConf*>(&to_msg);
  auto& from = static_cast<const RunModeConf&>(from_msg);
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      _this->_impl_.run_mode_ = from._impl_.run_mode_;
    }
    if (cached_has_bits & 0x00000002u) {
