...
class RunModeConf final :
 ...
 public:
  ...
  ~RunModeConf() override;
  explicit PROTOBUF_CONSTEXPR RunModeConf(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  RunModeConf* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const RunModeConf& from) {
    RunModeConf::MergeImpl(*this, from);
  }
  private:
...
inline ::apollo::cyber::proto::RunMode RunModeConf::_internal_run_mode() const {
  return static_cast< ::apollo::cyber::proto::RunMode >(_impl_.run_mode_);
}
...
inline ::apollo::cyber::proto::ClockMode RunModeConf::_internal_clock_mode() const {
  return static_cast< ::apollo::cyber::proto::ClockMode >(_impl_.clock_mode_);
}
