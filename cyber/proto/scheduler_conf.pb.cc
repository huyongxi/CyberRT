...
InnerThread::InnerThread(const InnerThread& from)
  ...
  InnerThread* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  if (from._internal_has_cpuset()) {
    _this->_impl_.cpuset_.Set(from._internal_cpuset(), 
      _this->GetArenaForAllocation());
  }
...
void InnerThread::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<InnerThread*>(&to_msg);
  auto& from = static_cast<const InnerThread&>(from_msg);
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_set_cpuset(from._internal_cpuset());
    }
    if (cached_has_bits & 0x00000004u) {
...
SchedulerConf::SchedulerConf(const SchedulerConf& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  SchedulerConf* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
  ...
  if (from._internal_has_process_level_cpuset()) {
    _this->_impl_.process_level_cpuset_.Set(from._internal_process_level_cpuset(), 
      _this->GetArenaForAllocation());
  }
  if (from._internal_has_classic_conf()) {
    _this->_impl_.classic_conf_ = new ::apollo::cyber::proto::ClassicConf(*from._impl_.classic_conf_);
  }
  if (from._internal_has_choreography_conf()) {
    _this->_impl_.choreography_conf_ = new ::apollo::cyber::proto::ChoreographyConf(*from._impl_.choreography_conf_);
  }
...
void SchedulerConf::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<SchedulerConf*>(&to_msg);
  auto& from = static_cast<const SchedulerConf&>(from_msg);
  ...
  if (cached_has_bits & 0x0000003fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_set_process_level_cpuset(from._internal_process_level_cpuset());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_mutable_classic_conf()->::apollo::cyber::proto::ClassicConf::MergeFrom(
          from._internal_classic_conf());
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_internal_mutable_choreography_conf()->::apollo::cyber::proto::ChoreographyConf::MergeFrom(
          from._internal_choreography_conf());
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.routine_num_ = from._impl_.routine_num_;
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.default_proc_num_ = from._impl_.default_proc_num_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
