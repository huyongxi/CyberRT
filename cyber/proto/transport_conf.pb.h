...
namespace cyber {
namespace proto {
class ArenaChannelConf;
struct ArenaChannelConfDefaultTypeInternal;
extern ArenaChannelConfDefaultTypeInternal _ArenaChannelConf_default_instance_;
class ArenaShmConf;
struct ArenaShmConfDefaultTypeInternal;
extern ArenaShmConfDefaultTypeInternal _ArenaShmConf_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::cyber::proto::ArenaChannelConf* Arena::CreateMaybeMessage<::apollo::cyber::proto::ArenaChannelConf>(Arena*);
template<> ::apollo::cyber::proto::ArenaShmConf* Arena::CreateMaybeMessage<::apollo::cyber::proto::ArenaShmConf>(Arena*);
...
class ShmMulticastLocator final :
 ...
 public:
  ...
  void MergeFrom( const ShmMulticastLocator& from) {
    ShmMulticastLocator::MergeImpl(*this, from);
  }
  private:
...
class ArenaChannelConf final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:apollo.cyber.proto.ArenaChannelConf) */ {
 public:
  inline ArenaChannelConf() : ArenaChannelConf(nullptr) {}
  ~ArenaChannelConf() override;
  explicit PROTOBUF_CONSTEXPR ArenaChannelConf(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ArenaChannelConf(const ArenaChannelConf& from);
  ArenaChannelConf(ArenaChannelConf&& from) noexcept
    : ArenaChannelConf() {
    *this = ::std::move(from);
  }

  inline ArenaChannelConf& operator=(const ArenaChannelConf& from) {
    CopyFrom(from);
    return *this;
  }
  inline ArenaChannelConf& operator=(ArenaChannelConf&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ArenaChannelConf& default_instance() {
    return *internal_default_instance();
  }
  static inline const ArenaChannelConf* internal_default_instance() {
    return reinterpret_cast<const ArenaChannelConf*>(
               &_ArenaChannelConf_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(ArenaChannelConf& a, ArenaChannelConf& b) {
    a.Swap(&b);
  }
  inline void Swap(ArenaChannelConf* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ArenaChannelConf* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ArenaChannelConf* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ArenaChannelConf>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ArenaChannelConf& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ArenaChannelConf& from) {
    ArenaChannelConf::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ArenaChannelConf* other);
  ...
  protected:
  explicit ArenaChannelConf(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    ...
    kSharedBufferSizeFieldNumber = 4,
    kMaxMsgSizeFieldNumber = 2,
    kMaxPoolSizeFieldNumber = 3,
  };
  ...
  bool has_shared_buffer_size() const;
  private:
  bool _internal_has_shared_buffer_size() const;
  public:
  void clear_shared_buffer_size();
  uint64_t shared_buffer_size() const;
  void set_shared_buffer_size(uint64_t value);
  private:
  uint64_t _internal_shared_buffer_size() const;
  void _internal_set_shared_buffer_size(uint64_t value);
  public:
  ...
  uint64_t max_msg_size() const;
  void set_max_msg_size(uint64_t value);
  private:
  uint64_t _internal_max_msg_size() const;
  void _internal_set_max_msg_size(uint64_t value);
  public:

  // optional uint64 max_pool_size = 3 [default = 32];
  bool has_max_pool_size() const;
  private:
  bool _internal_has_max_pool_size() const;
  public:
  void clear_max_pool_size();
  uint64_t max_pool_size() const;
  void set_max_pool_size(uint64_t value);
  private:
  uint64_t _internal_max_pool_size() const;
  void _internal_set_max_pool_size(uint64_t value);
  public:

  // @@protoc_insertion_point(class_scope:apollo.cyber.proto.ArenaChannelConf)
 private:
  class _Internal;
...
class ArenaShmConf final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:apollo.cyber.proto.ArenaShmConf) */ {
 public:
  inline ArenaShmConf() : ArenaShmConf(nullptr) {}
  ~ArenaShmConf() override;
  explicit PROTOBUF_CONSTEXPR ArenaShmConf(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ArenaShmConf(const ArenaShmConf& from);
  ArenaShmConf(ArenaShmConf&& from) noexcept
    : ArenaShmConf() {
    *this = ::std::move(from);
  }

  inline ArenaShmConf& operator=(const ArenaShmConf& from) {
    CopyFrom(from);
    return *this;
  }
  inline ArenaShmConf& operator=(ArenaShmConf&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ArenaShmConf& default_instance() {
    return *internal_default_instance();
  }
  static inline const ArenaShmConf* internal_default_instance() {
    return reinterpret_cast<const ArenaShmConf*>(
               &_ArenaShmConf_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(ArenaShmConf& a, ArenaShmConf& b) {
    a.Swap(&b);
  }
  inline void Swap(ArenaShmConf* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ArenaShmConf* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ArenaShmConf* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ArenaShmConf>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ArenaShmConf& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ArenaShmConf& from) {
    ArenaShmConf::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ArenaShmConf* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "apollo.cyber.proto.ArenaShmConf";
  }
  protected:
  explicit ArenaShmConf(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kArenaChannelConfFieldNumber = 1,
  };
  // repeated .apollo.cyber.proto.ArenaChannelConf arena_channel_conf = 1;
  int arena_channel_conf_size() const;
  private:
  int _internal_arena_channel_conf_size() const;
  public:
  void clear_arena_channel_conf();
  ::apollo::cyber::proto::ArenaChannelConf* mutable_arena_channel_conf(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::apollo::cyber::proto::ArenaChannelConf >*
      mutable_arena_channel_conf();
  private:
  const ::apollo::cyber::proto::ArenaChannelConf& _internal_arena_channel_conf(int index) const;
  ::apollo::cyber::proto::ArenaChannelConf* _internal_add_arena_channel_conf();
  public:
  const ::apollo::cyber::proto::ArenaChannelConf& arena_channel_conf(int index) const;
  ::apollo::cyber::proto::ArenaChannelConf* add_arena_channel_conf();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::apollo::cyber::proto::ArenaChannelConf >&
      arena_channel_conf() const;

  // @@protoc_insertion_point(class_scope:apollo.cyber.proto.ArenaShmConf)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::apollo::cyber::proto::ArenaChannelConf > arena_channel_conf_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_cyber_2fproto_2ftransport_5fconf_2eproto;
...
class ShmConf final :
 ...
 public:
  ...
  bool has_arena_shm_conf() const;
  private:
  bool _internal_has_arena_shm_conf() const;
  public:
  void clear_arena_shm_conf();
  const ::apollo::cyber::proto::ArenaShmConf& arena_shm_conf() const;
  PROTOBUF_NODISCARD ::apollo::cyber::proto::ArenaShmConf* release_arena_shm_conf();
  ::apollo::cyber::proto::ArenaShmConf* mutable_arena_shm_conf();
  void set_allocated_arena_shm_conf(::apollo::cyber::proto::ArenaShmConf* arena_shm_conf);
  private:
  const ::apollo::cyber::proto::ArenaShmConf& _internal_arena_shm_conf() const;
  ::apollo::cyber::proto::ArenaShmConf* _internal_mutable_arena_shm_conf();
  public:
  void unsafe_arena_set_allocated_arena_shm_conf(
      ::apollo::cyber::proto::ArenaShmConf* arena_shm_conf);
  ::apollo::cyber::proto::ArenaShmConf* unsafe_arena_release_arena_shm_conf();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::apollo::cyber::proto::ArenaShmConf* arena_shm_conf_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_cyber_2fproto_2ftransport_5fconf_2eproto;
};
...
class RtpsParticipantAttr final :
 ...
 public:
  ...
  void MergeFrom( const RtpsParticipantAttr& from) {
    RtpsParticipantAttr::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class CommunicationMode final :
 ...
 public:
  ...
  void MergeFrom( const CommunicationMode& from) {
    CommunicationMode::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class ResourceLimit final :
 ...
 public:
  ...
  void MergeFrom( const ResourceLimit& from) {
    ResourceLimit::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class TransportConf final :
 ...
 public:
  ...
  void MergeFrom( const TransportConf& from) {
    TransportConf::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
// optional string channel_name = 1;
inline bool ArenaChannelConf::_internal_has_channel_name() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool ArenaChannelConf::has_channel_name() const {
  return _internal_has_channel_name();
}
inline void ArenaChannelConf::clear_channel_name() {
  _impl_.channel_name_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const std::string& ArenaChannelConf::channel_name() const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.ArenaChannelConf.channel_name)
  return _internal_channel_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ArenaChannelConf::set_channel_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.channel_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:apollo.cyber.proto.ArenaChannelConf.channel_name)
}
inline std::string* ArenaChannelConf::mutable_channel_name() {
  std::string* _s = _internal_mutable_channel_name();
  // @@protoc_insertion_point(field_mutable:apollo.cyber.proto.ArenaChannelConf.channel_name)
  return _s;
}
inline const std::string& ArenaChannelConf::_internal_channel_name() const {
  return _impl_.channel_name_.Get();
}
inline void ArenaChannelConf::_internal_set_channel_name(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.channel_name_.Set(value, GetArenaForAllocation());
}
inline std::string* ArenaChannelConf::_internal_mutable_channel_name() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.channel_name_.Mutable(GetArenaForAllocation());
}
inline std::string* ArenaChannelConf::release_channel_name() {
  // @@protoc_insertion_point(field_release:apollo.cyber.proto.ArenaChannelConf.channel_name)
...
inline void ArenaChannelConf::set_allocated_channel_name(std::string* channel_name) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:apollo.cyber.proto.ArenaChannelConf.channel_name)
}

// optional uint64 max_msg_size = 2 [default = 33554432];
inline bool ArenaChannelConf::_internal_has_max_msg_size() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool ArenaChannelConf::has_max_msg_size() const {
  return _internal_has_max_msg_size();
}
inline void ArenaChannelConf::clear_max_msg_size() {
  _impl_.max_msg_size_ = uint64_t{33554432u};
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline uint64_t ArenaChannelConf::_internal_max_msg_size() const {
  return _impl_.max_msg_size_;
}
inline uint64_t ArenaChannelConf::max_msg_size() const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.ArenaChannelConf.max_msg_size)
  return _internal_max_msg_size();
}
inline void ArenaChannelConf::_internal_set_max_msg_size(uint64_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.max_msg_size_ = value;
}
inline void ArenaChannelConf::set_max_msg_size(uint64_t value) {
  _internal_set_max_msg_size(value);
  // @@protoc_insertion_point(field_set:apollo.cyber.proto.ArenaChannelConf.max_msg_size)
}

// optional uint64 max_pool_size = 3 [default = 32];
inline bool ArenaChannelConf::_internal_has_max_pool_size() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool ArenaChannelConf::has_max_pool_size() const {
  return _internal_has_max_pool_size();
}
inline void ArenaChannelConf::clear_max_pool_size() {
  _impl_.max_pool_size_ = uint64_t{32u};
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline uint64_t ArenaChannelConf::_internal_max_pool_size() const {
  return _impl_.max_pool_size_;
}
inline uint64_t ArenaChannelConf::max_pool_size() const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.ArenaChannelConf.max_pool_size)
  return _internal_max_pool_size();
}
inline void ArenaChannelConf::_internal_set_max_pool_size(uint64_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.max_pool_size_ = value;
}
inline void ArenaChannelConf::set_max_pool_size(uint64_t value) {
  _internal_set_max_pool_size(value);
  // @@protoc_insertion_point(field_set:apollo.cyber.proto.ArenaChannelConf.max_pool_size)
}

// optional uint64 shared_buffer_size = 4 [default = 0];
inline bool ArenaChannelConf::_internal_has_shared_buffer_size() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool ArenaChannelConf::has_shared_buffer_size() const {
  return _internal_has_shared_buffer_size();
}
inline void ArenaChannelConf::clear_shared_buffer_size() {
  _impl_.shared_buffer_size_ = uint64_t{0u};
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint64_t ArenaChannelConf::_internal_shared_buffer_size() const {
  return _impl_.shared_buffer_size_;
}
inline uint64_t ArenaChannelConf::shared_buffer_size() const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.ArenaChannelConf.shared_buffer_size)
  return _internal_shared_buffer_size();
}
inline void ArenaChannelConf::_internal_set_shared_buffer_size(uint64_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.shared_buffer_size_ = value;
}
inline void ArenaChannelConf::set_shared_buffer_size(uint64_t value) {
  _internal_set_shared_buffer_size(value);
  // @@protoc_insertion_point(field_set:apollo.cyber.proto.ArenaChannelConf.shared_buffer_size)
}
...
// repeated .apollo.cyber.proto.ArenaChannelConf arena_channel_conf = 1;
inline int ArenaShmConf::_internal_arena_channel_conf_size() const {
  return _impl_.arena_channel_conf_.size();
}
inline int ArenaShmConf::arena_channel_conf_size() const {
  return _internal_arena_channel_conf_size();
}
inline void ArenaShmConf::clear_arena_channel_conf() {
  _impl_.arena_channel_conf_.Clear();
}
inline ::apollo::cyber::proto::ArenaChannelConf* ArenaShmConf::mutable_arena_channel_conf(int index) {
  // @@protoc_insertion_point(field_mutable:apollo.cyber.proto.ArenaShmConf.arena_channel_conf)
  return _impl_.arena_channel_conf_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::apollo::cyber::proto::ArenaChannelConf >*
ArenaShmConf::mutable_arena_channel_conf() {
  // @@protoc_insertion_point(field_mutable_list:apollo.cyber.proto.ArenaShmConf.arena_channel_conf)
  return &_impl_.arena_channel_conf_;
}
inline const ::apollo::cyber::proto::ArenaChannelConf& ArenaShmConf::_internal_arena_channel_conf(int index) const {
  return _impl_.arena_channel_conf_.Get(index);
}
inline const ::apollo::cyber::proto::ArenaChannelConf& ArenaShmConf::arena_channel_conf(int index) const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.ArenaShmConf.arena_channel_conf)
  return _internal_arena_channel_conf(index);
}
inline ::apollo::cyber::proto::ArenaChannelConf* ArenaShmConf::_internal_add_arena_channel_conf() {
  return _impl_.arena_channel_conf_.Add();
}
inline ::apollo::cyber::proto::ArenaChannelConf* ArenaShmConf::add_arena_channel_conf() {
  ::apollo::cyber::proto::ArenaChannelConf* _add = _internal_add_arena_channel_conf();
  // @@protoc_insertion_point(field_add:apollo.cyber.proto.ArenaShmConf.arena_channel_conf)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::apollo::cyber::proto::ArenaChannelConf >&
ArenaShmConf::arena_channel_conf() const {
  // @@protoc_insertion_point(field_list:apollo.cyber.proto.ArenaShmConf.arena_channel_conf)
  return _impl_.arena_channel_conf_;
}
...
// optional .apollo.cyber.proto.ArenaShmConf arena_shm_conf = 4;
inline bool ShmConf::_internal_has_arena_shm_conf() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.arena_shm_conf_ != nullptr);
  return value;
}
inline bool ShmConf::has_arena_shm_conf() const {
  return _internal_has_arena_shm_conf();
}
inline void ShmConf::clear_arena_shm_conf() {
  if (_impl_.arena_shm_conf_ != nullptr) _impl_.arena_shm_conf_->Clear();
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline const ::apollo::cyber::proto::ArenaShmConf& ShmConf::_internal_arena_shm_conf() const {
  const ::apollo::cyber::proto::ArenaShmConf* p = _impl_.arena_shm_conf_;
  return p != nullptr ? *p : reinterpret_cast<const ::apollo::cyber::proto::ArenaShmConf&>(
      ::apollo::cyber::proto::_ArenaShmConf_default_instance_);
}
inline const ::apollo::cyber::proto::ArenaShmConf& ShmConf::arena_shm_conf() const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.ShmConf.arena_shm_conf)
  return _internal_arena_shm_conf();
}
inline void ShmConf::unsafe_arena_set_allocated_arena_shm_conf(
    ::apollo::cyber::proto::ArenaShmConf* arena_shm_conf) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.arena_shm_conf_);
  }
  _impl_.arena_shm_conf_ = arena_shm_conf;
  if (arena_shm_conf) {
    _impl_._has_bits_[0] |= 0x00000008u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000008u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.cyber.proto.ShmConf.arena_shm_conf)
}
inline ::apollo::cyber::proto::ArenaShmConf* ShmConf::release_arena_shm_conf() {
  _impl_._has_bits_[0] &= ~0x00000008u;
  ::apollo::cyber::proto::ArenaShmConf* temp = _impl_.arena_shm_conf_;
  _impl_.arena_shm_conf_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::apollo::cyber::proto::ArenaShmConf* ShmConf::unsafe_arena_release_arena_shm_conf() {
  // @@protoc_insertion_point(field_release:apollo.cyber.proto.ShmConf.arena_shm_conf)
  _impl_._has_bits_[0] &= ~0x00000008u;
  ::apollo::cyber::proto::ArenaShmConf* temp = _impl_.arena_shm_conf_;
  _impl_.arena_shm_conf_ = nullptr;
  return temp;
}
inline ::apollo::cyber::proto::ArenaShmConf* ShmConf::_internal_mutable_arena_shm_conf() {
  _impl_._has_bits_[0] |= 0x00000008u;
  if (_impl_.arena_shm_conf_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::cyber::proto::ArenaShmConf>(GetArenaForAllocation());
    _impl_.arena_shm_conf_ = p;
  }
  return _impl_.arena_shm_conf_;
}
inline ::apollo::cyber::proto::ArenaShmConf* ShmConf::mutable_arena_shm_conf() {
  ::apollo::cyber::proto::ArenaShmConf* _msg = _internal_mutable_arena_shm_conf();
  // @@protoc_insertion_point(field_mutable:apollo.cyber.proto.ShmConf.arena_shm_conf)
  return _msg;
}
inline void ShmConf::set_allocated_arena_shm_conf(::apollo::cyber::proto::ArenaShmConf* arena_shm_conf) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.arena_shm_conf_;
  }
  if (arena_shm_conf) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(arena_shm_conf);
    if (message_arena != submessage_arena) {
      arena_shm_conf = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, arena_shm_conf, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000008u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000008u;
  ...
  _impl_.arena_shm_conf_ = arena_shm_conf;
  // @@protoc_insertion_point(field_set_allocated:apollo.cyber.proto.ShmConf.arena_shm_conf)
}
