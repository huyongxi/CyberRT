...
ComponentInfo::ComponentInfo(const ComponentInfo& from)
  ...
  if (from._internal_has_config()) {
    _this->_impl_.config_ = new ::apollo::cyber::proto::ComponentConfig(*from._impl_.config_);
  }
...
void ComponentInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_config()->::apollo::cyber::proto::ComponentConfig::MergeFrom(
...
TimerComponentInfo::TimerComponentInfo(const TimerComponentInfo& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  TimerComponentInfo* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.class_name_){}
  ...
  if (from._internal_has_config()) {
    _this->_impl_.config_ = new ::apollo::cyber::proto::TimerComponentConfig(*from._impl_.config_);
  }
...
void TimerComponentInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<TimerComponentInfo*>(&to_msg);
  auto& from = static_cast<const TimerComponentInfo&>(from_msg);
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_config()->::apollo::cyber::proto::TimerComponentConfig::MergeFrom(
          from._internal_config());
    }
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
ModuleConfig::ModuleConfig(const ModuleConfig& from)
  ...
  if (from._internal_has_module_library()) {
    _this->_impl_.module_library_.Set(from._internal_module_library(), 
      _this->GetArenaForAllocation());
  }
...
void ModuleConfig::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.timer_components_.MergeFrom(from._impl_.timer_components_);
  if (from._internal_has_module_library()) {
...
DagConfig::DagConfig(const DagConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  DagConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void DagConfig::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
