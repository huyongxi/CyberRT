...
ReaderOption::ReaderOption(const ReaderOption& from)
  ...
  ReaderOption* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  if (from._internal_has_qos_profile()) {
    _this->_impl_.qos_profile_ = new ::apollo::cyber::proto::QosProfile(*from._impl_.qos_profile_);
  }
  _this->_impl_.pending_queue_size_ = from._impl_.pending_queue_size_;
...
void ReaderOption::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ReaderOption*>(&to_msg);
  auto& from = static_cast<const ReaderOption&>(from_msg);
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_mutable_qos_profile()->::apollo::cyber::proto::QosProfile::MergeFrom(
          from._internal_qos_profile());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.pending_queue_size_ = from._impl_.pending_queue_size_;
    }
...
ComponentConfig::ComponentConfig(const ComponentConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  ComponentConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
  ...
  if (from._internal_has_config_file_path()) {
    _this->_impl_.config_file_path_.Set(from._internal_config_file_path(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_flag_file_path()) {
    _this->_impl_.flag_file_path_.Set(from._internal_flag_file_path(), 
      _this->GetArenaForAllocation());
  }
...
void ComponentConfig::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.readers_.MergeFrom(from._impl_.readers_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_set_flag_file_path(from._internal_flag_file_path());
    }
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
TimerComponentConfig::TimerComponentConfig(const TimerComponentConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  TimerComponentConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.name_){}
...
void TimerComponentConfig::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<TimerComponentConfig*>(&to_msg);
  auto& from = static_cast<const TimerComponentConfig&>(from_msg);
