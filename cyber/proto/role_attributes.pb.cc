...
SocketAddr::SocketAddr(const SocketAddr& from)
  ...
  SocketAddr* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void SocketAddr::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<SocketAddr*>(&to_msg);
  auto& from = static_cast<const SocketAddr&>(from_msg);
...
RoleAttributes::RoleAttributes(const RoleAttributes& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RoleAttributes* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
  ...
  if (from._internal_has_socket_addr()) {
    _this->_impl_.socket_addr_ = new ::apollo::cyber::proto::SocketAddr(*from._impl_.socket_addr_);
  }
...
void RoleAttributes::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RoleAttributes*>(&to_msg);
  auto& from = static_cast<const RoleAttributes&>(from_msg);
  ...
  if (cached_has_bits & 0x00003f00u) {
    if (cached_has_bits & 0x00000100u) {
      _this->_internal_mutable_socket_addr()->::apollo::cyber::proto::SocketAddr::MergeFrom(
          from._internal_socket_addr());
    }
    if (cached_has_bits & 0x00000200u) {
