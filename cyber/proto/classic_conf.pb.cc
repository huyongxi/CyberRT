...
ClassicTask::ClassicTask(const ClassicTask& from)
  ...
  ClassicTask* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void ClassicTask::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ClassicTask*>(&to_msg);
  auto& from = static_cast<const ClassicTask&>(from_msg);
...
SchedGroup::SchedGroup(const SchedGroup& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  SchedGroup* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
  ...
  if (from._internal_has_affinity()) {
    _this->_impl_.affinity_.Set(from._internal_affinity(), 
      _this->GetArenaForAllocation());
  }
  ...
  if (from._internal_has_processor_policy()) {
    _this->_impl_.processor_policy_.Set(from._internal_processor_policy(), 
      _this->GetArenaForAllocation());
  }
...
void SchedGroup::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<SchedGroup*>(&to_msg);
  auto& from = static_cast<const SchedGroup&>(from_msg);
  ...
  if (cached_has_bits & 0x0000003fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_set_affinity(from._internal_affinity());
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_set_cpuset(from._internal_cpuset());
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_internal_set_processor_policy(from._internal_processor_policy());
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.processor_num_ = from._impl_.processor_num_;
    }
    if (cached_has_bits & 0x00000020u) {
      _this->_impl_.processor_prio_ = from._impl_.processor_prio_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
ClassicConf::ClassicConf(const ClassicConf& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  ClassicConf* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void ClassicConf::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ClassicConf*>(&to_msg);
  auto& from = static_cast<const ClassicConf&>(from_msg);
