...
UnitTest::UnitTest(const UnitTest& from)
  ...
  UnitTest* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void UnitTest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<UnitTest*>(&to_msg);
  auto& from = static_cast<const UnitTest&>(from_msg);
...
ChatterBenchmark::ChatterBenchmark(const ChatterBenchmark& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  ChatterBenchmark* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.content_){}
...
void ChatterBenchmark::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ChatterBenchmark*>(&to_msg);
  auto& from = static_cast<const ChatterBenchmark&>(from_msg);
